...
public class Engine: NSObject, ARSCNViewDelegate, ARSessionDelegate {
    ...
    public func placeSketchfabEntity(query: String) -> Entity {
        ...
        if let cameraTransform = _cameraTransform {
                ...
                let raycast = ARRaycastQuery(origin: cameraTransform.position, direction: -cameraTransform.forward, allowing: .estimatedPlane, alignment: .horizontal)
