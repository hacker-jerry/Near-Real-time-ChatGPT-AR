...
class ViewController: UIViewController {
    ...
    private var _localModel: Entity?
                    ...
                    audioCapture.queue.async {
                        if let segments = self._model?.infer(buffer: modelAudioInputBuffer) {
                            ...
                            DispatchQueue.main.async {
                                ...
                                self.toggleRecordButton.setTitle("录音", for: .normal)
...
//        let entity = try! ModelEntity.loadModel(named: "Models/airplane_usdz/airplane.usdz")
//
//        entity.generateCollisionShapes(recursive: true)
//
//        sceneView.scene.rootNode.addChildNode(entity)
    
//        _localModel = _engine?.placeSketchfabEntity(query: "airplane")
